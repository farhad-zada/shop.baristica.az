  ...
  return (
    <Link className='blogCard'>
        ...
        <div className="blogCard-body">
            ...
            <h2 className='blogCard-body_title green800 f20'>Гайд по AeroPress</h2>
            <p className='blogCard-body_description gray600 f16'>AeroPress - это превосходная кофеварка на одну чашку, которая использует экстракцию под высоким давлением для приготовления невероятной чашки кофе.</p>
        </div>
